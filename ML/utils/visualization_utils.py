...
def draw_bounding_box_on_image(current_frame_number,image,
  ...
  ## aici imi intra PIZDAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA
...
def visualize_boxes_and_labels_on_image_array(current_frame_number,
  ...
  for box, color in box_to_color_map.items():
    ...
    if ((targeted_objects != None) and (display_str_list[0].split(":")[0] in targeted_objects)):
            ...
            print(box)
            print("pizdaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")
